...
//*                                                                           *
//*****************************************************************************
REAL counterclockwiseadapt(triVertex *pa, triVertex *pb, triVertex *pc, REAL detsum)
{
...
//*                                                                           *
//*****************************************************************************
REAL incircleadapt(triVertex *pa, triVertex *pb, triVertex *pc, triVertex *pd, REAL permanent)
{
...
REAL incircleexact(triVertex * pa, triVertex *pb, triVertex * pc, triVertex * pd)
{
  ...
  deterlen = gpudt_fast_expansion_sum_zeroelim(ablen, abdet, cdlen, cddet, deter);
